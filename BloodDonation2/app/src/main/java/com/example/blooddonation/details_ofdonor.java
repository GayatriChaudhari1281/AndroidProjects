...
public class details_ofdonor extends AppCompatActivity {
    ...
    EditText t1;
    EditText t2;
    EditText email_d,contact_d,Date_d;
    TextView v1;
    Spinner sl;
    Spinner sl2;
    public String loc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Date_d=(EditText) findViewById(R.id.Date_d);
    ...
    public  void ADD_DONOR(View view ){
        ...
        if( hbcheckedflag == true && agecheckedflag == true && validcheckedflag== true && wtcheckedflag == true) {
            if(isvalid == false){
                ...
                if (db.adddonor(new Donors(name, Bldgrp, loc, email_d.getText().toString(), contact_d.getText().toString(),Date_d.getText().toString())) == true) {
